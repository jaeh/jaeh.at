    ...
    div({ class: 'section congregations' }, [
      ...
      ul([
        li([
          ...
          p('we are a tribe of makers, programmers, engineers, philosophers, activists, hackers, artists, clowns, and scientists.'),
    ...
    div({ class: 'section projects' }, [
      ...
      ul([
        li([
          ...
          p('open source hardware gadget for lighting, gaming, sound and persistence of vision applications.'),
        ]),
        li([
          h3([
            a({
          ...
          p('surf the web, watch videos or browse images the way you usually do, then show it on any screen and/or projector.'),
        ]),
        li([
          h3([
            a({
          ...
          p('magic static/serverless page generator. used to generate this page. publishes to github, gitlab, and any other git-pages style hosting)'),
        ]),
        li([
          a('???'),
        ]),
